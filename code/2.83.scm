...
(define (install-rational-package)
  ...
  (define (rational-raise x)
    ((get 'make 'scheme-number) (* (/ (numer x) (denom x)) 1.0)))
...
(define sn ((get 'make 'scheme-number) 2))
(define rn ((get 'make 'rational) 2 3))
(display sn)
(display "\traise to   ")
(display (raise sn))
...
(display (raise rn))
(newline)
(display rn) (display "\traise to   ")
(display (raise rn))(display "\tand raise to   ")
(display (raise(raise rn)))

;;;;the result should be print :
;2	raise to   (complex rectangular 2 . 0)
;(rational 2 . 3)	raise to   0.6666666666666666
;(rational 2 . 3)	raise to   0.6666666666666666	and raise to   (complex rectangular 0.6666666666666666 . 0)
